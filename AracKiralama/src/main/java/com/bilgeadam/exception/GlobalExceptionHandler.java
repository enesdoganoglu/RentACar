...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public ResponseEntity<ErrorMessage> handlerJava7MonoException(AracKiralamaException exception){
        System.out.println("AracKiralamaException hatası...: "+ exception.toString());
